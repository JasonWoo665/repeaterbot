...
async function rhino(connection, keyword, key){
    ...
    var videos = await youtube.searchVideos(keyword, 1).catch(err => {
        throw new TypeError("Invalid API Key For Youtube Search. Don't you have? Please go https://console.developers.google.com/ and get one.\nYoutube Araması İçin Geçersiz Api Key. Api Keyiniz yok mu? https://console.developers.google.com/ adresine gidip bir tane alınız.")
    })
    ...
    const dispatcher = await connection.play(ytdl(song.url, { filter: 'audioonly', volume: 0.5}))
...
function embed(id) {
    var searchUrl = 'https://youtube.com/embed/' + id;
    return searchUrl;
}
